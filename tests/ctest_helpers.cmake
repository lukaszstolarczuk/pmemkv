...
function(add_engine_test)
	...
	elseif("${TEST_DB_SIZE}" STREQUAL "MIN_JEMALLOC_ARENA_SIZE")
		...
		set(TEST_DB_SIZE_THRESHOLD 2147483646) # (2GB - 2b; nproc=256)
		message("calc: ${TEST_DB_SIZE}, threshold: ${TEST_DB_SIZE_THRESHOLD}")
		...
		message("calc: ${TEST_DB_SIZE}, minimum: ${TEST_DB_SIZE_MIN}")
